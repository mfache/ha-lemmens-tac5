...
class LemmensCoordinator(DataUpdateCoordinator):
    ...
    async def _async_update_data(self):
        try:
            ...
            status_result = await self.client.read_holding_registers(REG_OPERATING_MODE, count=34)
            ...
            if not alarm_result.isError():
                ...
                alarm_bits = {
                    0: "Erreur Programme", 1: "Erreur Données", 2: "Panne Ventilateur 1", 3: "Panne Ventilateur 2",
                    4: "Panne Ventilateur 3", 5: "Panne Ventilateur 4", 6: "Alarme Pression V1", 7: "Alarme Pression V2",
                    8: "Sonde T1 Ouverte", 9: "Sonde T1 Court-circuit", 10: "Sonde T2 Ouverte", 11: "Sonde T2 Court-circuit",
                    12: "Sonde T3 Ouverte", 13: "Sonde T3 Court-circuit", 14: "Sonde T4 Ouverte", 15: "Sonde T4 Court-circuit"
                }
                active_alarms = [text for bit, text in alarm_bits.items() if (val1 & (1 << bit)) != 0]
